...
html_theme_options = {
    'nav_title': 'SkyWater ReRAM 130nm PDK',

    'color_primary': 'light-green',
    'color_accent': 'teal',

    # Set the repo location to get a badge with stats
    'github_url': 'https://github.com/google/skywater-pdk-libs-sky130_fd_pr_reram',
    'repo_name': 'google/skywater-pdk-libs-sky130_fd_pr_reram',
